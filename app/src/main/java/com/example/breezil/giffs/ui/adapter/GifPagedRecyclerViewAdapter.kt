...
class GifPagedRecyclerViewAdapter(internal var context: Context, internal var gifClickListener: GifClickListener) :
    ListAdapter<Gif, GifPagedRecyclerViewAdapter.GiffHolder>(DIFF_CALLBACK) {
