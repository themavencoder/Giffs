...
import com.example.breezil.giffs.utils.Constant.Companion.ONE
...
@Singleton
class GiffsDataSource @Inject constructor(
//    internal var endpointRepository: EndpointRepository,
    ...
    override fun onInitialSuccess(
        ...
        if (response.data != null  &&response.data.size > ZERO) {
